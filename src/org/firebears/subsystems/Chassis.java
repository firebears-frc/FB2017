...
import static org.firebears.RobotMap.m_CountPerRev;
...
public class Chassis extends Subsystem {
    ...
    private final SpeedController frontLeft = RobotMap.chassisfrontLeft;
    private final SpeedController frontRight = RobotMap.chassisfrontRight;
    private final SpeedController rearLeft = RobotMap.chassisrearLeft;
    private final SpeedController rearRight = RobotMap.chassisrearRight;
...
//    	angle = RobotMap.navXBoard.getAngle();
    	...
    	robotDrive.driveCartesian(m_CountPerRev * x * -1, m_CountPerRev * y * -1, rotation, angle);
    }
