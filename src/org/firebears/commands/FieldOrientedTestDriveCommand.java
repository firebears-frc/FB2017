 ...
 */
public class FieldOrientedTestDriveCommand extends Command {
    ...
    public FieldOrientedTestDriveCommand() {
...
//    	SmartDashboard.putNumber("JoyY", forward);
    	...
    	if (RobotMap.navXBoard.getAngle() > 315 && RobotMap.navXBoard.getAngle() <= 45){
    		Robot.chassis.drive(strafe3, forward3, rotation3);
    	}else if (RobotMap.navXBoard.getAngle() > 45 && RobotMap.navXBoard.getAngle() <= 135){
    		Robot.chassis.drive(forward3, -strafe3, rotation3);
    	}else if (RobotMap.navXBoard.getAngle() > 135 && RobotMap.navXBoard.getAngle() <= 225){
    		Robot.chassis.drive(-strafe3, -forward3, rotation3);
    	}else if (RobotMap.navXBoard.getAngle() > 225 && RobotMap.navXBoard.getAngle() <= 315){
    		Robot.chassis.drive(-forward3, strafe3, rotation3);
    	}
