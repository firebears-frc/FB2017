...
//		RobotMap.chassisfrontLeft.set(50);
		...
		if(talonNum == 2){
			...
			lcd.setCursor(0, 1);
			lcd.print("" + RobotMap.chassisfrontLeft.getSelectedSensorVelocity(RobotMap.PID_IDX));
			lcd.setCursor(0, 2);
			lcd.print("" + RobotMap.chassisfrontLeft.getSelectedSensorPosition(RobotMap.PID_IDX));
			...
			lcd.setCursor(0, 1);
			lcd.print("" + RobotMap.chassisfrontRight.getSelectedSensorVelocity(RobotMap.PID_IDX));
			lcd.setCursor(0, 2);
			lcd.print("" + RobotMap.chassisfrontRight.getSelectedSensorPosition(RobotMap.PID_IDX));
			

		}else if(talonNum == 4){
			RobotMap.chassisrearLeft.set(150);	
			lcd.setCursor(0, 1);
			lcd.print("" + RobotMap.chassisrearLeft.getSelectedSensorVelocity(RobotMap.PID_IDX));
			lcd.setCursor(0, 2);
			lcd.print("" + RobotMap.chassisrearLeft.getSelectedSensorPosition(RobotMap.PID_IDX));

		}else if(talonNum == 5){
			RobotMap.chassisrearRight.set(150);	
			lcd.setCursor(0, 1);
			lcd.print("" + RobotMap.chassisrearRight.getSelectedSensorVelocity(RobotMap.PID_IDX));
			lcd.setCursor(0, 2);
			lcd.print("" + RobotMap.chassisrearRight.getSelectedSensorPosition(RobotMap.PID_IDX));
	...
	protected boolean isFinished() {
		...
		if(talonNum == 2 && Math.abs(RobotMap.chassisfrontLeft.getSelectedSensorVelocity(RobotMap.PID_IDX)) < 30){
    		lcd.home();
			...
			return false;
		}else if(talonNum == 3 && Math.abs(RobotMap.chassisfrontRight.getSelectedSensorVelocity(RobotMap.PID_IDX)) < 30){
			lcd.home();
			...
			return false;
		}else if(talonNum == 4 && Math.abs(RobotMap.chassisrearLeft.getSelectedSensorVelocity(RobotMap.PID_IDX)) < 30){
    		lcd.home();
			...
			return false;
		}else if(talonNum == 5 && Math.abs(RobotMap.chassisrearRight.getSelectedSensorVelocity(RobotMap.PID_IDX)) < 30){
    		lcd.home();
